...
public class NoteServiceTest {
    ...
    public void addNoteTest() {
        assertNotNull(service.addNote(new Note("br_desc", "fll_desc", new Date(), "special", 0, null), "login")); // Positive test; condition: current login exists in DB.
        assertNull(service.addNote(new Note("br_desc", "fll_desc", new Date(), "special", 0, null), "logan")); // Negative test; condition: current login does not exist in DB.
    }
